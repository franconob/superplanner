...
export default function InboxScreen() {
  const { getInboxTasks, insertTask, toggleTaskComplete } = useTaskDatabase();
  ...
  const load = useCallback(() => setTasks(getInboxTasks()), []);
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyWrap}>
                ...
                <Text style={styles.emptyText}>No inbox tasks</Text>
              </View>
            }
